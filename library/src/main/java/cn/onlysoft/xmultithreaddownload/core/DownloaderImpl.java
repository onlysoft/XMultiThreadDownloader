package cn.onlysoft.xmultithreaddownload.core;
...
import cn.onlysoft.xmultithreaddownload.DownloadRequest;
import cn.onlysoft.xmultithreaddownload.architecture.ConnectTask;
import cn.onlysoft.xmultithreaddownload.architecture.DownloadResponse;
import cn.onlysoft.xmultithreaddownload.architecture.DownloadStatus;
import cn.onlysoft.xmultithreaddownload.architecture.DownloadTask;
import cn.onlysoft.xmultithreaddownload.architecture.Downloader;
import cn.onlysoft.xmultithreaddownload.db.DataBaseManager;
import cn.onlysoft.xmultithreaddownload.db.ThreadInfo;
 ...
 *
 * update by xmren update the download state  of downloadInfo and save its to db
 */
public class DownloaderImpl implements Downloader, ConnectTask.OnConnectListener, DownloadTask.OnDownloadListener {
    ...
    private void init() {
        ...
        mDownloadInfo.setIcon(mRequest.getmIconUrl().toString());
    ...
    private void initDownloadTasks(long length, boolean acceptRanges) {
        ...
        mDBManager.createOrUpdateTask(mDownloadInfo);
    }
    ...
    private void createOrUpdateTaskState() {
        mDownloadInfo.setState(mStatus);
        mDBManager.createOrUpdateTask(mDownloadInfo);
    }
